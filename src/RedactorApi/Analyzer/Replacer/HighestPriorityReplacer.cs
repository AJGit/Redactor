...
public class HighestPriorityReplacer(ILogger<HighestPriorityReplacer> logger) : IReplacer
{
    private readonly ILogger<HighestPriorityReplacer> _logger = logger;
    ...
    public List<Analysis> FilterReplacements(float threshold, IEnumerable<Analysis> replacements)
    {
        ...
        return [.. filteredReplacements.OrderBy(r => r.Start)];
    }
}
